...
export default function Actions() {
  ...
  return (
    <VStack py={8} px={5} spacing={3}>
      <Button w="full" color="brand.white" bg="brand.blue" borderColor="brand.black" variant="solid">
        View Public Profile
      </Button>
      <InputGroup>
        <Input
        ...
        />
        <InputRightAddon borderColor="brand.main" bg="transparent" px={0} overflow="hidden">
